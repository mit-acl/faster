...
void CVX::goalCB(const acl_msgs::TermGoal& msg){
  ...
  if (msg.pos.x!=0.0 || msg.pos.y!=0){
    ...
    genNewTraj(u_max_,xf);
  }
}

void CVX::genNewTraj(double u_max, double xf[]){
  double x0[6] = {quadGoal_.pos.x,quadGoal_.pos.y,quadGoal_.pos.z,quadGoal_.vel.x,quadGoal_.vel.y,quadGoal_.vel.z};
...
void CVX::interpInput(double dt, double xf[], double u0[], double x0[], double ** u, double ** x, Eigen::MatrixXd &U, Eigen::MatrixXd &X){
...
void CVX::pubCB (const ros::TimerEvent& e){
  ...
  quadGoal_.vel.x = 0; quadGoal_.vel.y = 0; quadGoal_.vel.z = 0;
  quadGoal_.accel.x = 0; quadGoal_.accel.y = 0; quadGoal_.accel.z = 0;
  quadGoal_.jerk.x = 0; quadGoal_.jerk.y = 0; quadGoal_.jerk.z = 0;
